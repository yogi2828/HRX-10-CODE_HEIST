                            ...
                            return StreamBuilder<UserProgress?>(
                              ...
                              builder: (context, progressSnapshot) {
                                ...
                                if (userProgress != null) {
                                  ...
                                  userProgress.lessonsProgress.forEach((lessonId, progress) {
                                    totalLessonsCount++; // This counts all lessons in progress, might not be all course lessons
                                ...
                                return CourseProgressCard(
                                  ...
                                  totalLessons: totalLessonsCount, // This might need refinement based on how total lessons are stored/fetched.
            ...
            : isError
                ...
                : Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: AppConstants.spacing),
                      Text(
                        'Levels Completed: ${lessonsCompleted}/${course.levelIds.length} (approximated)',
                        style: const TextStyle(color: AppColors.textColorSecondary, fontSize: 12),
                      ),
                    ],
                  ),
